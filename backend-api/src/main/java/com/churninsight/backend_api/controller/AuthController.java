...
import com.churninsight.backend_api.dto.LoginDto;
import com.churninsight.backend_api.dto.RegisterDto;
import com.churninsight.backend_api.dto.AuthErrorResponse;
import com.churninsight.backend_api.dto.LoginJwtResponse;
import com.churninsight.backend_api.exception.EmailAlreadyExistsException;
import com.churninsight.backend_api.exception.PasswordMismatchException;
import com.churninsight.backend_api.model.Login;
import com.churninsight.backend_api.repository.LoginRepository;
import com.churninsight.backend_api.security.JwtUtil;
...
public class AuthController {
    ...
    @Autowired
    public AuthController(LoginRepository loginRepository, PasswordEncoder passwordEncoder, JwtUtil jwtUtil,
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody RegisterDto registerDto) {
        ...
        Optional<Login> existing = loginRepository.findByEmail(email);
